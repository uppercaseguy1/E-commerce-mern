                ...
                <div className="flex items-center justify-between px-4 md:px-8 py-3">
                    ...
                    <form onSubmit={handleSearch} className="hidden md:flex items-center flex-1 max-w-md mx-8">
                        <input
                            ...
                            className="w-full px-4 py-2 bg-gray-700 text-white rounded-l-lg focus:outline-none focus:ring-2 focus:ring-pink-500 placeholder-gray-400"
                        />
                        <button
                            type="submit"
                            className="bg-pink-500 hover:bg-pink-600 px-4 py-2 rounded-r-lg text-white transition-all"
                        >
                    ...
                    <div className="flex items-center gap-4 md:gap-6">
                        ...
                        {userInfo ? (
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 bg-pink-500 hover:bg-pink-600 text-white rounded-lg transition-all font-medium hidden sm:flex"
                            >
                                <FaUser size={16} />
                                <span>Login</span>
                            </button>
