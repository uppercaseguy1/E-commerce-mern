        ...
        <>
            ...
            <nav className="fixed top-0 left-0 right-0 bg-gradient-to-r from-gray-900 via-gray-800 to-black shadow-lg z-[9999] border-b border-pink-500/20">
                <div className="flex items-center justify-between px-4 md:px-8 py-3">
                    ...
                    {/* Desktop Search Bar */}
                    <form onSubmit={handleSearch} className="hidden md:flex items-center gap-3 flex-1 max-w-lg mx-6">
                        <input
                            type="text"
                            placeholder="Search products..."
                            value={searchQuery}
                            onChange={(e) => setSearchQuery(e.target.value)}
                            className="flex-1 px-4 py-2.5 bg-gray-700 text-white text-sm rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 placeholder-gray-400 transition-all border-0"
                        />
                        <button
                            type="submit"
                            className="bg-gray-700 hover:bg-gray-600 p-2.5 rounded-lg text-gray-300 hover:text-white transition-all flex items-center justify-center border-0"
                        >
